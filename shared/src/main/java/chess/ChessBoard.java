...
public class ChessBoard {
    ...
    public void resetBoard() {
        ChessPiece.PieceType[] gamePieceLayout = {ChessPiece.PieceType.ROOK, ChessPiece.PieceType.KNIGHT, ChessPiece.PieceType.BISHOP,
        ...
        for (var col = 1; col <= gameBoard.length; col++) {
            addPiece(new ChessPosition(1, col), new ChessPiece(ChessGame.TeamColor.WHITE, gamePieceLayout[col-1]));
            addPiece(new ChessPosition(8, col), new ChessPiece(ChessGame.TeamColor.BLACK, gamePieceLayout[col-1]));
